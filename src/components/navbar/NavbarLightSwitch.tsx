...
export default function NavbarLightSwitch() {
    const {setTheme, theme} = useTheme();

    return (
        <>
            <div className={"hover:bg-[--md-sys-color-secondary-container] cursor-pointer py-2 px-3 rounded-3xl block"}
                 onClick={() => {
                     if (theme == "light") {
                         setTheme("dark");
                     } else {
                ...
                {theme == "light"
                    ? <svg className={"fill-[--md-sys-color-on-surface]"} xmlns="http://www.w3.org/2000/svg" height="24"
                           width="24" viewBox="0 -960 960 960">
